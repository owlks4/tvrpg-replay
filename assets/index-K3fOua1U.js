...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:kn,depthTest:!1,depthWrite:!1})}function Lo(){return new wn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:as(),fragmentShader:`
		...
		`,blending:kn,depthTest:!1,depthWrite:!1})}function Po(){return new wn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:as(),fragmentShader:`
		...
		`,blending:kn,depthTest:!1,depthWrite:!1})}function as(){return`
	...
	`}function am(r){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const c=o.mapping,d=c===za||c===Va,l=c===bi||c===Ci;if(d||l)if(o.isRenderTargetTexture&&o.needsPMREMUpdate===!0){o.needsPMREMUpdate=!1;let u=e.get(o);return t===null&&(t=new Ro(r)),u=d?t.fromEquirectangular(o,u):t.fromCubemap(o,u),e.set(o,u),u.texture}else{if(e.has(o))return e.get(o).texture;{const u=o.image;if(d&&u&&u.height>0||l&&u&&i(u)){t===null&&(t=new Ro(r));const h=d?t.fromEquirectangular(o):t.fromCubemap(o);return e.set(o,h),o.addEventListener("dispose",a),h.texture}else return null}}}return o}function i(o){let c=0;const d=6;for(let l=0;l<d;l++)o[l]!==void 0&&c++;return c===d}function a(o){const c=o.target;c.removeEventListener("dispose",a);const d=e.get(c);d!==void 0&&(e.delete(c),d.dispose())}function s(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:s}}function sm(r){const e={};function t(n){if(e[n]!==void 0)return e[n];let i;switch(n){case"WEBGL_depth_texture":i=r.getExtension("WEBGL_depth_texture")||r.getExtension("MOZ_WEBGL_depth_texture")||r.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=r.getExtension("EXT_texture_filter_anisotropic")||r.getExtension("MOZ_EXT_texture_filter_anisotropic")||r.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=r.getExtension("WEBGL_compressed_texture_s3tc")||r.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=r.getExtension("WEBGL_compressed_texture_pvrtc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=r.getExtension(n)}return e[n]=i,i}return{has:function(n){return t(n)!==null},init:function(n){n.isWebGL2?(t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance")):(t("WEBGL_depth_texture"),t("OES_texture_float"),t("OES_texture_half_float"),t("OES_texture_half_float_linear"),t("OES_standard_derivatives"),t("OES_element_index_uint"),t("OES_vertex_array_object"),t("ANGLE_instanced_arrays")),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture")},get:function(n){const i=t(n);return i===null&&console.warn("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function om(r,e,t,n){const i={},a=new WeakMap;function s(u){const h=u.target;h.index!==null&&e.remove(h.index);for(const g in h.attributes)e.remove(h.attributes[g]);for(const g in h.morphAttributes){const _=h.morphAttributes[g];for(let f=0,m=_.length;f<m;f++)e.remove(_[f])}h.removeEventListener("dispose",s),delete i[h.id];const p=a.get(h);p&&(e.remove(p),a.delete(h)),n.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function o(u,h){return i[h.id]===!0||(h.addEventListener("dispose",s),i[h.id]=!0,t.memory.geometries++),h}function c(u){const h=u.attributes;for(const g in h)e.update(h[g],r.ARRAY_BUFFER);const p=u.morphAttributes;for(const g in p){const _=p[g];for(let f=0,m=_.length;f<m;f++)e.update(_[f],r.ARRAY_BUFFER)}}function d(u){const h=[],p=u.index,g=u.attributes.position;let _=0;if(p!==null){const y=p.array;_=p.version;for(let v=0,T=y.length;v<T;v+=3){const L=y[v+0],C=y[v+1],A=y[v+2];h.push(L,C,C,A,A,L)}}else if(g!==void 0){const y=g.array;_=g.version;for(let v=0,T=y.length/3-1;v<T;v+=3){const L=v+0,C=v+1,A=v+2;h.push(L,C,C,A,A,L)}}else return;const f=new(Kc(h)?nd:td)(h,1);f.version=_;const m=a.get(u);m&&e.remove(m),a.set(u,f)}function l(u){const h=a.get(u);if(h){const p=u.index;p!==null&&h.version<p.version&&d(u)}else d(u);return a.get(u)}return{get:o,update:c,getWireframeAttribute:l}}function cm(r,e,t,n){const i=n.isWebGL2;let a;function s(p){a=p}let o,c;function d(p){o=p.type,c=p.bytesPerElement}function l(p,g){r.drawElements(a,g,o,p*c),t.update(g,a,1)}function u(p,g,_){if(_===0)return;let f,m;if(i)f=r,m="drawElementsInstanced";else if(f=e.get("ANGLE_instanced_arrays"),m="drawElementsInstancedANGLE",f===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}f[m](a,g,o,p*c,_),t.update(g,a,_)}function h(p,g,_){if(_===0)return;const f=e.get("WEBGL_multi_draw");if(f===null)for(let m=0;m<_;m++)this.render(p[m]/c,g[m]);else{f.multiDrawElementsWEBGL(a,g,0,o,p,0,_);let m=0;for(let y=0;y<_;y++)m+=g[y];t.update(m,a,1)}}this.setMode=s,this.setIndex=d,this.render=l,this.renderInstances=u,this.renderMultiDraw=h}function dm(r){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(a,s,o){switch(t.calls++,s){case r.TRIANGLES:t.triangles+=o*(a/3);break;case r.LINES:t.lines+=o*(a/2);break;case r.LINE_STRIP:t.lines+=o*(a-1);break;case r.LINE_LOOP:t.lines+=o*a;break;case r.POINTS:t.points+=o*a;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",s);break}}function i(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:i,update:n}}function lm(r,e){return r[0]-e[0]}function um(r,e){return Math.abs(e[1])-Math.abs(r[1])}function hm(r,e,t){const n={},i=new Float32Array(8),a=new WeakMap,s=new $e,o=[];for(let d=0;d<8;d++)o[d]=[d,0];function c(d,l,u){const h=d.morphTargetInfluences;if(e.isWebGL2===!0){const g=l.morphAttributes.position||l.morphAttributes.normal||l.morphAttributes.color,_=g!==void 0?g.length:0;let f=a.get(l);if(f===void 0||f.count!==_){let G=function(){ne.dispose(),a.delete(l),l.removeEventListener("dispose",G)};var p=G;f!==void 0&&f.texture.dispose();const v=l.morphAttributes.position!==void 0,T=l.morphAttributes.normal!==void 0,L=l.morphAttributes.color!==void 0,C=l.morphAttributes.position||[],A=l.morphAttributes.normal||[],z=l.morphAttributes.color||[];let re=0;v===!0&&(re=1),T===!0&&(re=2),L===!0&&(re=3);let x=l.attributes.position.count*re,b=1;x>e.maxTextureSize&&(b=Math.ceil(x/e.maxTextureSize),x=e.maxTextureSize);const W=new Float32Array(x*b*4*_),ne=new $c(W,x,b,_);ne.type=jt,ne.needsUpdate=!0;const P=re*4;for(let O=0;O<_;O++){const j=C[O],V=A[O],X=z[O],q=x*b*4*O;for(let ie=0;ie<j.count;ie++){const oe=ie*P;v===!0&&(s.fromBufferAttribute(j,ie),W[q+oe+0]=s.x,W[q+oe+1]=s.y,W[q+oe+2]=s.z,W[q+oe+3]=0),T===!0&&(s.fromBufferAttribute(V,ie),W[q+oe+4]=s.x,W[q+oe+5]=s.y,W[q+oe+6]=s.z,W[q+oe+7]=0),L===!0&&(s.fromBufferAttribute(X,ie),W[q+oe+8]=s.x,W[q+oe+9]=s.y,W[q+oe+10]=s.z,W[q+oe+11]=X.itemSize===4?s.w:1)}}f={count:_,texture:ne,size:new Ae(x,b)},a.set(l,f),l.addEventListener("dispose",G)}let m=0;for(let v=0;v<h.length;v++)m+=h[v];const y=l.morphTargetsRelative?1:1-m;u.getUniforms().setValue(r,"morphTargetBaseInfluence",y),u.getUniforms().setValue(r,"morphTargetInfluences",h),u.getUniforms().setValue(r,"morphTargetsTexture",f.texture,t),u.getUniforms().setValue(r,"morphTargetsTextureSize",f.size)}else{const g=h===void 0?0:h.length;let _=n[l.id];if(_===void 0||_.length!==g){_=[];for(let T=0;T<g;T++)_[T]=[T,0];n[l.id]=_}for(let T=0;T<g;T++){const L=_[T];L[0]=T,L[1]=h[T]}_.sort(um);for(let T=0;T<8;T++)T<g&&_[T][1]?(o[T][0]=_[T][0],o[T][1]=_[T][1]):(o[T][0]=Number.MAX_SAFE_INTEGER,o[T][1]=0);o.sort(lm);const f=l.morphAttributes.position,m=l.morphAttributes.normal;let y=0;for(let T=0;T<8;T++){const L=o[T],C=L[0],A=L[1];C!==Number.MAX_SAFE_INTEGER&&A?(f&&l.getAttribute("morphTarget"+T)!==f[C]&&l.setAttribute("morphTarget"+T,f[C]),m&&l.getAttribute("morphNormal"+T)!==m[C]&&l.setAttribute("morphNormal"+T,m[C]),i[T]=A,y+=A):(f&&l.hasAttribute("morphTarget"+T)===!0&&l.deleteAttribute("morphTarget"+T),m&&l.hasAttribute("morphNormal"+T)===!0&&l.deleteAttribute("morphNormal"+T),i[T]=0)}const v=l.morphTargetsRelative?1:1-y;u.getUniforms().setValue(r,"morphTargetBaseInfluence",v),u.getUniforms().setValue(r,"morphTargetInfluences",i)}}return{update:c}}function fm(r,e,t,n){let i=new WeakMap;function a(c){const d=n.render.frame,l=c.geometry,u=e.get(c,l);if(i.get(u)!==d&&(e.update(u),i.set(u,d)),c.isInstancedMesh&&(c.hasEventListener("dispose",o)===!1&&c.addEventListener("dispose",o),i.get(c)!==d&&(t.update(c.instanceMatrix,r.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,r.ARRAY_BUFFER),i.set(c,d))),c.isSkinnedMesh){const h=c.skeleton;i.get(h)!==d&&(h.update(),i.set(h,d))}return u}function s(){i=new WeakMap}function o(c){const d=c.target;d.removeEventListener("dispose",o),t.remove(d.instanceMatrix),d.instanceColor!==null&&t.remove(d.instanceColor)}return{update:a,dispose:s}}class od extends mt{constructor(e,t,n,i,a,s,o,c,d,l){if(l=l!==void 0?l:Kn,l!==Kn&&l!==wi)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&l===Kn&&(n=yn),n===void 0&&l===wi&&(n=Yn),super(null,i,a,s,o,c,l,n,d),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:ft,this.minFilter=c!==void 0?c:ft,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const cd=new mt,dd=new od(1,1);dd.compareFunction=jc;const ld=new $c,ud=new Ql,hd=new ad,Do=[],No=[],Io=new Float32Array(16),Fo=new Float32Array(9),Uo=new Float32Array(4);function Fi(r,e,t){const n=r[0];if(n<=0||n>0)return r;const i=e*t;let a=Do[i];if(a===void 0&&(a=new Float32Array(i),Do[i]=a),e!==0){n.toArray(a,0);for(let s=1,o=0;s!==e;++s)o+=t,r[s].toArray(a,o)}return a}function dt(r,e){if(r.length!==e.length)return!1;for(let t=0,n=r.length;t<n;t++)if(r[t]!==e[t])return!1;return!0}function lt(r,e){for(let t=0,n=e.length;t<n;t++)r[t]=e[t]}function Zr(r,e){let t=No[e];t===void 0&&(t=new Int32Array(e),No[e]=t);for(let n=0;n!==e;++n)t[n]=r.allocateTextureUnit();return t}function mm(r,e){const t=this.cache;t[0]!==e&&(r.uniform1f(this.addr,e),t[0]=e)}function pm(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(r.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(dt(t,e))return;r.uniform2fv(this.addr,e),lt(t,e)}}function gm(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(r.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(r.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(dt(t,e))return;r.uniform3fv(this.addr,e),lt(t,e)}}function _m(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(r.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(dt(t,e))return;r.uniform4fv(this.addr,e),lt(t,e)}}function Sm(r,e){const t=this.cache,n=e.elements;if(n===void 0){if(dt(t,e))return;r.uniformMatrix2fv(this.addr,!1,e),lt(t,e)}else{if(dt(t,n))return;Uo.set(n),r.uniformMatrix2fv(this.addr,!1,Uo),lt(t,n)}}function xm(r,e){const t=this.cache,n=e.elements;if(n===void 0){if(dt(t,e))return;r.uniformMatrix3fv(this.addr,!1,e),lt(t,e)}else{if(dt(t,n))return;Fo.set(n),r.uniformMatrix3fv(this.addr,!1,Fo),lt(t,n)}}function vm(r,e){const t=this.cache,n=e.elements;if(n===void 0){if(dt(t,e))return;r.uniformMatrix4fv(this.addr,!1,e),lt(t,e)}else{if(dt(t,n))return;Io.set(n),r.uniformMatrix4fv(this.addr,!1,Io),lt(t,n)}}function Em(r,e){const t=this.cache;t[0]!==e&&(r.uniform1i(this.addr,e),t[0]=e)}function Mm(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(r.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(dt(t,e))return;r.uniform2iv(this.addr,e),lt(t,e)}}function ym(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(r.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(dt(t,e))return;r.uniform3iv(this.addr,e),lt(t,e)}}function Tm(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(r.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(dt(t,e))return;r.uniform4iv(this.addr,e),lt(t,e)}}function Am(r,e){const t=this.cache;t[0]!==e&&(r.uniform1ui(this.addr,e),t[0]=e)}function km(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(r.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(dt(t,e))return;r.uniform2uiv(this.addr,e),lt(t,e)}}function bm(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(r.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(dt(t,e))return;r.uniform3uiv(this.addr,e),lt(t,e)}}function Cm(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(r.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(dt(t,e))return;r.uniform4uiv(this.addr,e),lt(t,e)}}function Rm(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i);const a=this.type===r.SAMPLER_2D_SHADOW?dd:cd;t.setTexture2D(e||a,i)}function wm(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),t.setTexture3D(e||ud,i)}function Lm(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),t.setTextureCube(e||hd,i)}function Pm(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),t.setTexture2DArray(e||ld,i)}function Dm(r){switch(r){case 5126:return mm;case 35664:return pm;case 35665:return gm;case 35666:return _m;case 35674:return Sm;case 35675:return xm;case 35676:return vm;case 5124:case 35670:return Em;case 35667:case 35671:return Mm;case 35668:case 35672:return ym;case 35669:case 35673:return Tm;case 5125:return Am;case 36294:return km;case 36295:return bm;case 36296:return Cm;case 35678:case 36198:case 36298:case 36306:case 35682:return Rm;case 35679:case 36299:case 36307:return wm;case 35680:case 36300:case 36308:case 36293:return Lm;case 36289:case 36303:case 36311:case 36292:return Pm}}function Nm(r,e){r.uniform1fv(this.addr,e)}function Im(r,e){const t=Fi(e,this.size,2);r.uniform2fv(this.addr,t)}function Fm(r,e){const t=Fi(e,this.size,3);r.uniform3fv(this.addr,t)}function Um(r,e){const t=Fi(e,this.size,4);r.uniform4fv(this.addr,t)}function Bm(r,e){const t=Fi(e,this.size,4);r.uniformMatrix2fv(this.addr,!1,t)}function Om(r,e){const t=Fi(e,this.size,9);r.uniformMatrix3fv(this.addr,!1,t)}function Gm(r,e){const t=Fi(e,this.size,16);r.uniformMatrix4fv(this.addr,!1,t)}function Hm(r,e){r.uniform1iv(this.addr,e)}function zm(r,e){r.uniform2iv(this.addr,e)}function Vm(r,e){r.uniform3iv(this.addr,e)}function Wm(r,e){r.uniform4iv(this.addr,e)}function Xm(r,e){r.uniform1uiv(this.addr,e)}function qm(r,e){r.uniform2uiv(this.addr,e)}function jm(r,e){r.uniform3uiv(this.addr,e)}function Ym(r,e){r.uniform4uiv(this.addr,e)}function Km(r,e,t){const n=this.cache,i=e.length,a=Zr(t,i);dt(n,a)||(r.uniform1iv(this.addr,a),lt(n,a));for(let s=0;s!==i;++s)t.setTexture2D(e[s]||cd,a[s])}function Qm(r,e,t){const n=this.cache,i=e.length,a=Zr(t,i);dt(n,a)||(r.uniform1iv(this.addr,a),lt(n,a));for(let s=0;s!==i;++s)t.setTexture3D(e[s]||ud,a[s])}function Zm(r,e,t){const n=this.cache,i=e.length,a=Zr(t,i);dt(n,a)||(r.uniform1iv(this.addr,a),lt(n,a));for(let s=0;s!==i;++s)t.setTextureCube(e[s]||hd,a[s])}function $m(r,e,t){const n=this.cache,i=e.length,a=Zr(t,i);dt(n,a)||(r.uniform1iv(this.addr,a),lt(n,a));for(let s=0;s!==i;++s)t.setTexture2DArray(e[s]||ld,a[s])}function Jm(r){switch(r){case 5126:return Nm;case 35664:return Im;case 35665:return Fm;case 35666:return Um;case 35674:return Bm;case 35675:return Om;case 35676:return Gm;case 5124:case 35670:return Hm;case 35667:case 35671:return zm;case 35668:case 35672:return Vm;case 35669:case 35673:return Wm;case 5125:return Xm;case 36294:return qm;case 36295:return jm;case 36296:return Ym;case 35678:case 36198:case 36298:case 36306:case 35682:return Km;case 35679:case 36299:case 36307:return Qm;case 35680:case 36300:case 36308:case 36293:return Zm;case 36289:case 36303:case 36311:case 36292:return $m}}class ep{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Dm(t.type)}}class tp{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Jm(t.type)}}class np{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const i=this.seq;for(let a=0,s=i.length;a!==s;++a){const o=i[a];o.setValue(e,t[o.id],n)}}}const Ra=/(\w+)(\])?(\[|\.)?/g;function Bo(r,e){r.seq.push(e),r.map[e.id]=e}function ip(r,e,t){const n=r.name,i=n.length;for(Ra.lastIndex=0;;){const a=Ra.exec(n),s=Ra.lastIndex;let o=a[1];const c=a[2]==="]",d=a[3];if(c&&(o=o|0),d===void 0||d==="["&&s+2===i){Bo(t,d===void 0?new ep(o,r,e):new tp(o,r,e));break}else{let u=t.map[o];u===void 0&&(u=new np(o),Bo(t,u)),t=u}}}class Ur{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const a=e.getActiveUniform(t,i),s=e.getUniformLocation(t,a.name);ip(a,s,this)}}setValue(e,t,n,i){const a=this.map[t];a!==void 0&&a.setValue(e,n,i)}setOptional(e,t,n){const i=t[n];i!==void 0&&this.setValue(e,n,i)}static upload(e,t,n,i){for(let a=0,s=t.length;a!==s;++a){const o=t[a],c=n[o.id];c.needsUpdate!==!1&&o.setValue(e,c.value,i)}}static seqWithValue(e,t){const n=[];for(let i=0,a=e.length;i!==a;++i){const s=e[i];s.id in t&&n.push(s)}return n}}function Oo(r,e,t){const n=r.createShader(e);return r.shaderSource(n,t),r.compileShader(n),n}const rp=37297;let ap=0;function sp(r,e){const t=r.split(`
`),n=[],i=Math.max(e-6,0),a=Math.min(e+6,t.length);for(let s=i;s<a;s++){const o=s+1;n.push(`${o===e?">":" "} ${o}: ${t[s]}`)}return n.join(`
`)}function op(r){const e=Ye.getPrimaries(Ye.workingColorSpace),t=Ye.getPrimaries(r);let n;switch(e===t?n="":e===zr&&t===Hr?n="LinearDisplayP3ToLinearSRGB":e===Hr&&t===zr&&(n="LinearSRGBToLinearDisplayP3"),r){case _t:case jr:return[n,"LinearTransferOETF"];case at:case ns:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",r),[n,"LinearTransferOETF"]}}function Go(r,e,t){const n=r.getShaderParameter(e,r.COMPILE_STATUS),i=r.getShaderInfoLog(e).trim();if(n&&i==="")return"";const a=/ERROR: 0:(\d+)/.exec(i);if(a){const s=parseInt(a[1]);return t.toUpperCase()+`

`+i+`

`+sp(r.getShaderSource(e),s)}else return i}function cp(r,e){const t=op(e);return`vec4 ${r}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function dp(r,e){let t;switch(e){case rl:t="Linear";break;case al:t="Reinhard";break;case sl:t="OptimizedCineon";break;case ol:t="ACESFilmic";break;case dl:t="AgX";break;case cl:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+r+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function lp(r){return[r.extensionDerivatives||r.envMapCubeUVHeight||r.bumpMap||r.normalMapTangentSpace||r.clearcoatNormalMap||r.flatShading||r.alphaToCoverage||r.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(r.extensionFragDepth||r.logarithmicDepthBuffer)&&r.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",r.extensionDrawBuffers&&r.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(r.extensionShaderTextureLOD||r.envMap||r.transmission)&&r.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(yi).join(`
`)}function up(r){return[r.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",r.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(yi).join(`
`)}function hp(r){const e=[];for(const t in r){const n=r[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function fp(r,e){const t={},n=r.getProgramParameter(e,r.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const a=r.getActiveAttrib(e,i),s=a.name;let o=1;a.type===r.FLOAT_MAT2&&(o=2),a.type===r.FLOAT_MAT3&&(o=3),a.type===r.FLOAT_MAT4&&(o=4),t[s]={type:a.type,location:r.getAttribLocation(e,s),locationSize:o}}return t}function yi(r){return r!==""}function Ho(r,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return r.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function zo(r,e){return r.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const mp=/^[ \t]*#include +<([\w\d./]+)>/gm;function Ka(r){return r.replace(mp,gp)}const pp=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function gp(r,e){let t=Ie[e];if(t===void 0){const n=pp.get(e);if(n!==void 0)t=Ie[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Ka(t)}const _p=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Vo(r){return r.replace(_p,Sp)}function Sp(r,e,t,n){let i="";for(let a=parseInt(e);a<parseInt(t);a++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+a+" ]").replace(/UNROLLED_LOOP_INDEX/g,a);return i}function Wo(r){let e=`precision ${r.precision} float;
...
#define LOW_PRECISION`),e}function xp(r){let e="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===Nc?e="SHADOWMAP_TYPE_PCF":r.shadowMapType===Pd?e="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===cn&&(e="SHADOWMAP_TYPE_VSM"),e}function vp(r){let e="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case bi:case Ci:e="ENVMAP_TYPE_CUBE";break;case qr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Ep(r){let e="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case Ci:e="ENVMAP_MODE_REFRACTION";break}return e}function Mp(r){let e="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case Ic:e="ENVMAP_BLENDING_MULTIPLY";break;case nl:e="ENVMAP_BLENDING_MIX";break;case il:e="ENVMAP_BLENDING_ADD";break}return e}function yp(r){const e=r.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Tp(r,e,t,n){const i=r.getContext(),a=t.defines;let s=t.vertexShader,o=t.fragmentShader;const c=xp(t),d=vp(t),l=Ep(t),u=Mp(t),h=yp(t),p=t.isWebGL2?"":lp(t),g=up(t),_=hp(a),f=i.createProgram();let m,y,v=t.glslVersion?"#version "+t.glslVersion+`
